...
void draw()
{
  ...
  // y-axis label
  rotate(-PI / 2);
  text("VALUE1", width * -0.5, height * 0.023);
  rotate(PI / 2);
  ...
  for (TableRow row : table.rows())
  {
    ...
    //line(tick_y_axis_x1_val, y_axis_y1_val - (value1 * 4.5), tick_y_axis_x2_val, y_axis_y1_val - (value1 * 4.5));
    // draw corresponding value
    //text(value1, tick_y_axis_x_num, (y_axis_y1_val - (value1 * 4.5) + (height * 0.005)));
