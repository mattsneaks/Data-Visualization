...
void draw()
{
  ...
  if (table.getColumnTitle(2).equals("ACT") && table.getColumnTitle(3).equals("GPA"))
  {
    // TEXT SECTION
    // center aligns all text
    textAlign(CENTER);
    // title
    text("ACT VS GPA SCORES", width / 2, height * 0.02);
    //x-axis label
    text("ACT", width / 2, height * 0.99);
    // y-axis label
    rotate(-PI / 2);
    text("GPA", width / -2.5, height * 0.023);
    rotate(PI / 2);
  }
  else if (table.getColumnTitle(1).equals("Horsepower") && table.getColumnTitle(2).equals("Weight (lb)"))
  {
    // TEXT SECTION
    // center aligns all text
    textAlign(CENTER);
    // title
    text("HORSEPOWER VS WEIGHT", width / 2, height * 0.02);
    //x-axis label
    text("HORSEPOWER", width / 2, height * 0.99);
    // y-axis label
    rotate(-PI / 2);
    text("WIEGHT", width / -2.5, height * 0.023);
    rotate(PI / 2);
  }
  ...
  if (table.getColumnTitle(2).equals("ACT") && table.getColumnTitle(3).equals("GPA"))
  {
    ...
    for (TableRow row : table.rows())
    {
      ...
      if (count == table.getRowCount())
      {
        ...
        float mid_y_value = (zero_y_value + max_y_value) / 2;
        ...
        float first_quarter_y_value = (zero_y_value + mid_y_value) / 2;
        ...
        float third_quarter_y_value = (mid_y_value + max_y_value) / 2;
        ...
        float first_eighth_y_value = (zero_y_value + first_quarter_y_value) / 2;
        ...
        float second_eighth_y_value = (first_quarter_y_value + mid_y_value) / 2;
        ...
        float third_eighth_y_value = (mid_y_value + third_quarter_y_value) / 2;
        ...
        float fourth_eighth_y_value = (third_quarter_y_value + max_y_value) / 2;
